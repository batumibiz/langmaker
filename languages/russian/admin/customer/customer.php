...
$_['text_authorize']           = 'История авторизаций';
...
$_['column_type']              = 'Тип';
$_['column_date_expire']       = 'Дата окончания';
...
// Help
$_['help_safe']                = 'Установите значение Да, чтобы одобрить этого клиента, если он был пойман системой по борьбе с мошенничеством';
...
$_['error_customer']           = 'Предупреждение: Клиент не существует!';
$_['error_exists']             = 'Данный E-Mail уже зарегистрирован!';
$_['error_address']            = 'Предупреждение: Адрес не существует!';
...
$_['error_regex']              = '%s это недопустимый ввод!';
